...
const Review = () => {
	return (
		<section className="mt-[40%] review bg-gradient-to-r from-[#c0ffe2] to-[#76dfff] rounded-xl flex h-[650px] lg: flex-wrap container mx-auto">
			<div className="ml-[70px] text-slate-50 pt-[155px]">
			...
			<div className="shadow-2xl bg-white h-[250px] w-[394px] rounded-l ml-[1066px] mt-[385px] z-10 absolute bg-white opacity-25">
			...
			<div className="shadow-2xl bg-white h-[250px] w-[394px] rounded-l ml-[966px] mt-[233px] z-10 absolute">
